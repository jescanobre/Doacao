...
public class meusRecebidos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meus_recebidos);
        ...
        Query query1=mDatabaseRef.orderByChild("idReceptor").equalTo(usuarioDados.getId());
        query1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data:dataSnapshot.getChildren()){
                    ...
                    final ArrayAdapter arrayAdapter = new ArrayAdapter(meusRecebidos.this,android.R.layout.simple_list_item_1,lista); //add lista no adapter
                    ...
                    listaObjs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(meusRecebidos.this, string, Toast.LENGTH_SHORT).show();
                            acha(string);
        ...
        query1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data:dataSnapshot.getChildren()){
                    ...
                    String nome=models.getTitulo();
                    System.out.println("objeto detalhe nome : " + nome);
                    Intent intent = new Intent(meusRecebidos.this, MeuObjetoDetalhe.class);
